        ...
        <div class="menu_list" style="width:200px;float:left">
            ...
            <el-row class="tac h100">
                <el-col :span="12" class="h100">
                    <el-menu :default-active="router.path" router class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b" :collapse="isCollapse">
